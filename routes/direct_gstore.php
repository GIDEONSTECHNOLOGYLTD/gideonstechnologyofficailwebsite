<?php
/**
 * Direct GStore Route Implementation
 * 
 * This file contains a direct implementation of the GStore route
 * to ensure it works properly regardless of other route registrations.
 */
...
// Define a global flag for GStore routes if not already defined
if (!defined('DIRECT_GSTORE_ROUTE_REGISTERED')) {
    define('DIRECT_GSTORE_ROUTE_REGISTERED', true);
}

return function (App $app) {
    // Register the GStore route directly
