<?php
/**
 * Direct GStore Route Handler
 * 
 * This is a standalone file to test the GStore route independently
 * of the main application routing system.
 */
...
// Create a minimal Slim application
