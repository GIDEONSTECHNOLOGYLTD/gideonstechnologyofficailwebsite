<?php
/**
 * Registration template for Gideons Technology
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo isset($appName) ? htmlspecialchars($appName) : 'Gideons Technology'; ?> - Register</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/auth/register" method="post">
                            ...
                            echo CsrfProtection::tokenField();
                            ?>
                            <div class="mb-3">
