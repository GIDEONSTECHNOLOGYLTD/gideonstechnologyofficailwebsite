<?php
/**
 * GTech E-commerce Templates Page
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>E-commerce Templates | <?= $appName ?? 'Gideons Technology' ?></title>
...
<body>
    ...
    <div class="container py-5">
        <header class="text-center mb-5">
            ...
            <p class="lead">Professional, responsive templates for your online store</p>
        </header>
            ...
            <div class="col-12">
                <div class="d-flex justify-content-center">
                    <div class="btn-group" role="group">
                        ...
                        <a href="/gtech/templates/ecommerce" class="btn btn-primary active">E-commerce</a>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <h3 class="text-center mb-4">Features of Our E-commerce Templates</h3>
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <h5>Shopping Cart</h5>
                                <p>Fully-featured shopping cart with product management</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <p>Ready for integration with popular payment gateways</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
    ...
    <section class="bg-light py-5">
        <div class="container text-center">
            <h2>Need a Custom E-commerce Solution?</h2>
            <p class="lead mb-4">Our team can create a custom online store tailored to your business needs</p>
